...
private:
	...
	void SetMotorGains();
	//measured value
	static float Accel_Value_x;
	static float Accel_Value_y;
	static float Accel_Value_z;
	//calibrated constant
	static float Accel_Center_x;
	static float Accel_Center_y;
	static float Accel_Center_z;
	...
	static std::shared_ptr<BuiltInAccelerometer> RoboAccels;
	static const size_t kBufferSize = 10;
	static CircularBuffer<float> AccelerometerBuffer;
	Notifier AccelService;
	static void UpdateChassisAngle();
