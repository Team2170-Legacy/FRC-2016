...
OI::OI() {
    ...
    SmartDashboard::PutData("Autonomous Position Command", new AutonomousPositionCommand());
    SmartDashboard::PutData("Autonomous Velocity Command", new AutonomousVelocityCommand());
