...
#define SHOOTER_ANGLE 2000
// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR

AutonomousShooterAim::AutonomousShooterAim(): Command() {
...
bool AutonomousShooterAim::IsFinished() {
    return ((Robot::shooter->GetShooterElevation() > SHOOTER_ANGLE) ||
    		Robot::shooter->ShooterAtMax());
}
