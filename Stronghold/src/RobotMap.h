...
public:
	...
	static std::shared_ptr<DigitalInput> shooterBallKickSensor;
	static std::shared_ptr<SpeedController> climberHookMotor;
	static std::shared_ptr<DigitalInput> climberHookRearMax;
	static std::shared_ptr<DigitalInput> climberHookMax;
	static std::shared_ptr<DigitalInput> climberHookHome;
