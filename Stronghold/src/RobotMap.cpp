...
void RobotMap::init() {
    ...
    shooterElevationHome.reset(new DigitalInput(2));
    lw->AddSensor("Shooter", "Elevation Home", shooterElevationHome);
    
    shooterElevationMax.reset(new DigitalInput(3));
