...
std::shared_ptr<SpeedController> RobotMap::climberHookMotor;
std::shared_ptr<DigitalInput> RobotMap::climberHookRearMax;
std::shared_ptr<DigitalInput> RobotMap::climberHookMax;
std::shared_ptr<DigitalInput> RobotMap::climberHookHome;
...
void RobotMap::init() {
    ...
    climberHookMotor.reset(new Talon(3));
    lw->AddActuator("Climber", "Hook Motor", std::static_pointer_cast<Talon>(climberHookMotor));
    
    climberHookRearMax.reset(new DigitalInput(7));
    lw->AddSensor("Climber", "Hook Rear Max", climberHookRearMax);
    
    climberHookMax.reset(new DigitalInput(6));
    lw->AddSensor("Climber", "Hook Max", climberHookMax);
    
    climberHookHome.reset(new DigitalInput(5));
    lw->AddSensor("Climber", "Hook Home", climberHookHome);
